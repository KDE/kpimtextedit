...
void TestPlainMarkupOutput::testSingleFormat()
{
    ...
    QRegExp regex( QString::fromLatin1( "^This \\*text\\* is bold.\\n$" ) );
...
void TestPlainMarkupOutput::testDoubleFormat()
{
    ...
    md->constructContent( doc );
    QString result = hb->getResult();
    QRegExp regex( QString::fromLatin1( "^Some (\\*/|/\\*)formatted(\\*/|/\\*) text.\\n$" ) );
...
void TestPlainMarkupOutput::testAnchor()
{
    ...
    QRegExp regex( QString::fromLatin1( "^A link\\[1\\] to KDE.\\n\\n---- References ----\\n\\[1\\] http://www.kde.org\\n$" ) );
...
void TestPlainMarkupOutput::testAnchorWithFormattedContent()
{
    ...
    QRegExp regex( QString::fromLatin1( "^A \\*formatted\\* link\\[1\\] to KDE.\\n\\n---- References ----\\n\\[1\\] http://www.kde.org\\n$" ) );
...
void TestPlainMarkupOutput::testAdjacentAnchors()
{
    ...
    QRegExp regex( QString::fromLatin1( "^Two links\\[1\\]next\\[2\\] to eachother.\\n\\n---- References ----\\n\\[1\\] http://www.kde.org\\n\\[2\\] http://www.google.com\\n$" ) );
...
void TestPlainMarkupOutput::testNestedFormatting()
{
    ...
    QRegExp regex( QString::fromLatin1( "^This \\*text is /italic/ and\\* bold.\\n$" ) );
...
void TestPlainMarkupOutput::testSpan()
{
    ...
    QRegExp regex = QRegExp( QString::fromLatin1("^Some formatted text.\\n$") );
